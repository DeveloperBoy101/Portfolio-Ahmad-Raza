...
const projects = [
  {
    ...
    desc: "Full stack MERN e-commerce platform with payment gateway integration.",
    tech: ["JS", "React", "Node.js", "Express", "MongoDB"],
    img: "./Stack.png",
    link: "#",
  },
  {
    title: "Real Estate Frontened Page",
    desc: "A real state frontened only website with carousel .",
  ...
  {
    title: "A frontened Restraunt Booking website",
  ...
  {
    title: "Frontened Ecommerse Page",
